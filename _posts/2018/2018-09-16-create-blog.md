...
但如果我们只是在 GitHub 上面使用的话，到不需要知道 Jekyll 的语法，一般 Github 会自动将我们写的 Markdown  文件转换成静态页面。使用 Jekyll 需要使用 Markdown 语法来写你的文章，不过 Markdown 语法非常简单，做为程序员来讲基本上两三天就掌握了，大家也可以参考这篇文章：[markdown 使用总结](https://www.trisonlu.com/other/2015/10/18/markdown-summary.html)。
...
- [千里追踪博客之殇](https://www.trisonlu.com/other/2017/09/10/blog-stop-a-month.html)
- [历时25天，我的博客（www.trisonlu.com）终于又活了过来](https://www.trisonlu.com/life/2018/06/10/my-blog-back.html)
- [技术博客那些事儿](https://www.trisonlu.com/other/2017/07/16/operating-technology-blog.html)
...
![](https://www.trisonlu.com/assets/images/2018/it/blog1.png)
...
1、首先打开地址[https://github.com/trisonlu/trisonlu.github.io](https://github.com/trisonlu/trisonlu.github.io)，点击 Fork 按钮将代码复制一份到自己的仓库。

![](https://www.trisonlu.com/assets/images/2018/it/blog8.png)

过上一分钟，你的 github 仓库发现一个 trisonlu.github.io 项目。
...
![](https://www.trisonlu.com/assets/images/2018/it/blog9.png)

4、重命名项目

点击 Settings 按钮打开设置页面，重命名项目名称为：github_username.github.io。

![](https://www.trisonlu.com/assets/images/2018/it/blog11.png)
...
![](https://www.trisonlu.com/assets/images/2018/it/blog10.png)
...
![](https://www.trisonlu.com/assets/images/2018/it/blogcdn.png)

> 空框内，需要填写自己`github_username`值。

然后重新打开项目的 Settings > GitHub Pages 页面，Custom domain 下的输入框输入刚才设置的域名：xxx.com，点击保存即可。

![](https://www.trisonlu.com/assets/images/2018/it/jiexi.png)
...
```
cd /usr/local/trisonlu.github.io
git pull http://github.com/trisonlu/trisonlu.github.io.git
