...
我们使用上一节的内容[Spring Boot 2.0(七)：Spring Boot 如何解决项目启动时初始化资源](http://www.trisonlu.com/springboot/2018/05/03/spring-boot-commandLineRunner.html),利用 CommandLineRunner 在项目启动的时候配置好 MemcachedClient 。
...
**[示例代码-github](https://github.com/trisonlu/spring-boot-examples)**

**[示例代码-码云](https://gitee.com/trisonlu/spring-boot-examples)**
